...
- **nuke** is a custom built PC running Debian Stable. It has an AMD Ryzen 5 CPU, 1 TB SSD, two 4 TB HDDS, and a NVIDIA GTX 1060.
- **inferno** is a Raspberry Pi 4 running a headless Debian Lite.
- **ancient** is a Dell Optiplex 7040 (SFF) running FreeBSD 14.4-RELEASE. It has an external drive dock that holds two 500 GB HDDs.
